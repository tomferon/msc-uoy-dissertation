...
The code used to generate these results is available in the accompanying file \path{notebook.py} which uses bindings to the C++ pricer in \path{src/python.cpp}.
