...
FIXME: Explain the problem with the volatility smile.

FIXME: The BS model can be extended to solve this discrepancy. Mention stochastic volatility models and say local volatility models have the advantage of being simpler.

FIXME: Explain that the prices of call options satisfy a PDE (Dupire's Equation) and explain the advantage.

FIXME: Introduce the paper this dissertation is based on.

FIXME: Provide a step-by-step description of what's covered by the dissertation. "In Section 2, we introduce ..."

FIXME: Rephrase: Most results are provided with a reference. However, some results were required for which no references were found. A proof is always provided in these cases.

\section{Contribution}

FIXME

FIXME: Collated and harmonised material from different sources using different notations, definitions and terminologies into something coherent.
