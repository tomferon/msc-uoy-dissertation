...
%%%%%%%%%%%%%
\begin{definition}
  The \textbf{stochastic integral}, also called It\^o integral, of a process $X \in \mathcal{S}^2$ is defined as
  \begin{align*}
...
\begin{definition}
  The \textbf{stochastic integral} of $X \in \mathcal{M}^2$ is
  \begin{align*}
...
\begin{definition}
  ...
  \end{align}
  for some $a, b : [0,T] \times \Omega \to \mathbb{R}$, called the \textbf{characteristics} of the It\^o process, such that $a$ is $\mathcal{F}^W_t$-adapted and satisfies $\int_0^T |a(s)| \mathrm{d}s < \infty$ almost surely, and $b \in \mathcal{M}^2$.
  %%%%%%%%%%%%%
