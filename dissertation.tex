...
Running the program outputs the following, where we can see that the pricer using finite difference methods produces similar prices than the ones we get from Monte Carlo simulations.
